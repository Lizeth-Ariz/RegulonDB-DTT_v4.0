 ...
 */
 ...
 import Description from "./components/Description";
 import Title from "./components/dtt_title";
 import RDBdata from "./components/RegulonDB_data/rdb_data";        //<FormRegulondbData /> <UserData />
 ...
 const tabs = [
   <div id="01">
     <article>
       <Description loc={"regulonDB"} />
       <RDBdata/>
     </article>
   </div>,
   <div id="02">
     <article>
       <Description loc={"UserData"}  />
     </article>
   </div>
 ];
